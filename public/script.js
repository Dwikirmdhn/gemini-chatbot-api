...
form.addEventListener('submit', async function (e) {
  ...
  try {
    ...
    if (data && data.result) {
      ...
      // To prevent XSS, it's better to handle the response more carefully.
      // For now, we trust the markdown converter.
      botMessageElement.innerHTML = `<strong>Gemini:</strong> ${htmlContent}`;
    } else {
